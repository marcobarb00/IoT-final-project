...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b6c458, const void *arg_0xb7b6c5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b1d8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79c7840), 
int (*key_eq_fn)(void *arg_0xb79c7c88, void *arg_0xb79c7e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78969b8, int arg_0xb7896b10);
static double RandomUniform(void );
...
} __attribute__((packed)) communication_channel_t;
...
typedef TMilli LightProtC$Timer0$precision_tag;
typedef TMilli LightProtC$Timer3$precision_tag;
typedef TMilli LightProtC$Timer1$precision_tag;
typedef TMilli LightProtC$Timer2$precision_tag;
...
static void LightProtC$Timer0$fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void LightProtC$AMControl$startDone(error_t error);
#line 138
static void LightProtC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void LightProtC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void LightProtC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LightProtC$Timer3$fired(void );
#line 83
static void LightProtC$Timer1$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LightProtC$Timer2$fired(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
static error_t LedsP$Init$init(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static bool LightProtC$Timer0$isRunning(void );
#line 73
static void LightProtC$Timer0$startOneShot(uint32_t dt);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t LightProtC$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t LightProtC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LightProtC$Timer3$startOneShot(uint32_t dt);
...
uint8_t len);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LightProtC$Timer1$startOneShot(uint32_t dt);
#line 73
static void LightProtC$Timer2$startOneShot(uint32_t dt);
# 31 "LightProtC.nc"
message_t LightProtC$packet_buf[1000];


message_t LightProtC$queued_packet[1000];
uint16_t LightProtC$queue_addr[1000];

uint16_t LightProtC$time_delays[1000][9];


bool LightProtC$connect_sent[1000];
bool LightProtC$connack_sent[1000];
bool LightProtC$subscribe_sent[1000];
bool LightProtC$suback_sent[1000];
bool LightProtC$publish_sent[1000];

bool LightProtC$locked[1000];

static inline bool LightProtC$actual_send(uint16_t address, message_t *packet);
static bool LightProtC$generate_send(uint16_t address, message_t *packet, uint16_t type);


communication_channel_t LightProtC$communication_channels[1000][8];


bool LightProtC$connect_acked[1000];
bool LightProtC$subscribe_acked[1000];


uint16_t LightProtC$subscribe_topic[1000];


uint16_t LightProtC$simulation[1000];



static inline void LightProtC$initialize_communication_channels(void );
#line 83
static void LightProtC$send_connect_message(void );
#line 97
static inline void LightProtC$send_connack_message(int id);
#line 110
static inline void LightProtC$send_subscribe_message(__nesc_nxbase_nx_uint16_t topic);
#line 126
static bool LightProtC$generate_send(uint16_t address, message_t *packet, uint16_t type);
#line 176
static inline void LightProtC$Timer0$fired(void );
...
static inline bool LightProtC$actual_send(uint16_t address, message_t *packet);
#line 197
static inline void LightProtC$Boot$booted(void );




static inline void LightProtC$AMControl$startDone(error_t err);
#line 220
static inline void LightProtC$AMControl$stopDone(error_t err);



static inline void LightProtC$Timer1$fired(void );
...
static inline void LightProtC$Timer2$fired(void );
...
static inline void LightProtC$Timer3$fired(void );
...
static inline message_t *LightProtC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 270
static void LightProtC$AMSend$sendDone(message_t *bufPtr, error_t error);
# 46 "/opt/tinyos-main-2.1.2/tos/interfaces/GeneralIO.nc"
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * LightProtC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 97
{
  ...
  sim_log_debug(149U, "radio_pack", "sending a connack message to mote: %d \n", id);

  connack_message = (msg_t *)LightProtC$Packet$getPayload(&LightProtC$packet_buf[sim_node()], sizeof(msg_t ));

  __nesc_hton_uint16(connack_message->type.nxdata, 2);


  LightProtC$generate_send(id, &LightProtC$packet_buf[sim_node()], 2);
}
...
#line 247
{
  ...
  uint16_t id = __nesc_ntoh_uint16(message->id.nxdata);
  communication_channel_t communication_channel = LightProtC$communication_channels[sim_node()][id - 2];

  if (TOS_NODE_ID == 1) {
      if (__nesc_ntoh_uint16(message->type.nxdata) == 1) {
          if (__nesc_ntoh_uint16(communication_channel.status.nxdata) == 0) {
              LightProtC$send_connack_message(id);
            }
          else 
#line 256
            {
              sim_log_debug(160U, "radio_rec", "node %d already connected, dropping connect packet\n", id);
            }
        }
    }
  else 
#line 260
    {
      if (__nesc_ntoh_uint16(message->type.nxdata) == 2) {
          sim_log_debug(161U, "radio_rec", "CONNACK received\n");
          LightProtC$connect_acked[sim_node()] = TRUE;
        }
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7639ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7639ac8) {
#line 78
    case 10:
#line 78
      __nesc_result = LightProtC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7639ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static bool LightProtC$Timer0$isRunning(void ){
#line 92
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void LightProtC$Timer0$startOneShot(uint32_t dt){
#line 73
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7637178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7637178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t LightProtC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void LightProtC$Timer3$startOneShot(uint32_t dt){
#line 73
...
#line 66
{
  ...
  while (i < 8) {
      __nesc_hton_uint16(communication_channel.status.nxdata, 0);
      __nesc_hton_uint16(communication_channel.subscribed_topic.nxdata, 0);

      LightProtC$communication_channels[sim_node()][i] = communication_channel;
...
#line 202
{
  if (err == SUCCESS) {
      if (TOS_NODE_ID == 1) {
          sim_log_debug(154U, "radio", "PANC radio start done\n");
          LightProtC$initialize_communication_channels();
        }
      else {
          sim_log_debug(155U, "radio", "Node %d: radio start done\n", TOS_NODE_ID);

          LightProtC$Timer3$startOneShot(2000);
        }
    }
  else {
      sim_log_error(156U, "radio", "Node %d: radio failed to start, retrying...\n", TOS_NODE_ID);
      LightProtC$AMControl$start();
    }
}
...
#line 113
  LightProtC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 220
{
  sim_log_debug(157U, "radio", "node %d: radio stopped\n", TOS_NODE_ID);
}
...
#line 138
  LightProtC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7639108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7639108, msg, error);
#line 110
}
#line 110
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LightProtC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74896a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74896a8) {
#line 100
    case 0U:
#line 100
      /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74896a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77f2650){
#line 75
  switch (arg_0xb77f2650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77f2650);
#line 75
      break;
#line 75
    }
...
#line 75
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74870a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74870a0, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 10);
  return /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t LightProtC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LightProtAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 184
{
  if (!LightProtC$locked[sim_node()]) {
      if (LightProtC$AMSend$send(address, packet, sizeof(msg_t )) == SUCCESS) {
          sim_log_debug(151U, "radio_send", "Sending packet");
          LightProtC$locked[sim_node()] = TRUE;
...
#line 176
{
  ...
  LightProtC$actual_send(LightProtC$queue_addr[sim_node()], &LightProtC$queued_packet[sim_node()]);
}
...
#line 224
{
  ...
  sim_log_debug(158U, "timer", "node %d did not receive a CONNACK in time\n", TOS_NODE_ID);
  if (LightProtC$connect_acked[sim_node()] == FALSE) {
      LightProtC$send_connect_message();
    }
}
...
#line 110
{
  ...
  sim_log_debug(150U, "radio_pack", "sending a subscribe message\n");

  subscribe_message = (msg_t *)LightProtC$Packet$getPayload(&LightProtC$packet_buf[sim_node()], sizeof(msg_t ));

  __nesc_hton_uint16(subscribe_message->id.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(subscribe_message->type.nxdata, 3);
  __nesc_hton_uint16(subscribe_message->topic.nxdata, topic);


  LightProtC$generate_send(1, &LightProtC$packet_buf[sim_node()], 3);
}
...
#line 232
{
  ...
  if (LightProtC$subscribe_acked[sim_node()] == FALSE) {
      sim_log_debug(159U, "timer", "node %d did not receive a SUBACK in time\n", TOS_NODE_ID);
      LightProtC$send_subscribe_message(LightProtC$subscribe_topic[sim_node()]);
    }
}
...
#line 240
{
  ...
  if (LightProtC$simulation[sim_node()] == 1) {
      LightProtC$send_connect_message();
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb730a3a8){
#line 83
  switch (arg_0xb730a3a8) {
#line 83
    case 0U:
#line 83
      LightProtC$Timer0$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      LightProtC$Timer1$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      LightProtC$Timer2$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      LightProtC$Timer3$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb730a3a8);
#line 83
      break;
#line 83
    }
...
#line 67
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void LightProtC$Timer1$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(1U, dt);
#line 73
}
#line 73
inline static void LightProtC$Timer2$startOneShot(uint32_t dt){
#line 73
...
{
#line 139
  if (LightProtC$Timer0$isRunning()) {
      return FALSE;
    }
  else 
#line 141
    {
      if (type == 1 && !LightProtC$connect_sent[sim_node()]) {
          LightProtC$connect_sent[sim_node()] = TRUE;
          LightProtC$Timer0$startOneShot(LightProtC$time_delays[sim_node()][TOS_NODE_ID - 1]);
          LightProtC$queued_packet[sim_node()] = *packet;
          LightProtC$queue_addr[sim_node()] = address;
        }
      else {
#line 147
        if (type == 2 && !LightProtC$connack_sent[sim_node()]) {
            LightProtC$connack_sent[sim_node()] = TRUE;
            LightProtC$Timer0$startOneShot(LightProtC$time_delays[sim_node()][TOS_NODE_ID - 1]);
            LightProtC$queued_packet[sim_node()] = *packet;
            LightProtC$queue_addr[sim_node()] = address;
          }
...
#line 152
          if (type == 3 && !LightProtC$subscribe_sent[sim_node()]) {
              LightProtC$subscribe_sent[sim_node()] = TRUE;
              LightProtC$Timer0$startOneShot(LightProtC$time_delays[sim_node()][TOS_NODE_ID - 1]);
              LightProtC$queued_packet[sim_node()] = *packet;
              LightProtC$queue_addr[sim_node()] = address;
            }
...
#line 157
            if (type == 4 && !LightProtC$suback_sent[sim_node()]) {
                LightProtC$suback_sent[sim_node()] = TRUE;
                LightProtC$Timer0$startOneShot(LightProtC$time_delays[sim_node()][TOS_NODE_ID - 1]);
                LightProtC$queued_packet[sim_node()] = *packet;
                LightProtC$queue_addr[sim_node()] = address;
              }
...
#line 162
              if (type == 5 && !LightProtC$publish_sent[sim_node()]) {
                  LightProtC$publish_sent[sim_node()] = TRUE;
                  LightProtC$Timer0$startOneShot(LightProtC$time_delays[sim_node()][TOS_NODE_ID - 1]);
                  LightProtC$queued_packet[sim_node()] = *packet;
                  LightProtC$queue_addr[sim_node()] = address;
                }
...
#line 83
{
  ...
  sim_log_debug(148U, "radio_pack", "sending a connect message\n");

  connect_message = (msg_t *)LightProtC$Packet$getPayload(&LightProtC$packet_buf[sim_node()], sizeof(msg_t ));

  __nesc_hton_uint16(connect_message->id.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(connect_message->type.nxdata, 1);


  LightProtC$generate_send(1, &LightProtC$packet_buf[sim_node()], 1);
}
...
#line 270
{
  ...
  if (error == SUCCESS) {
      sim_log_debug(162U, "radio_send", "Packet sent...");
      sim_log_debug_clear(163U, "radio_send", " at time %s \n", sim_time_string());

      message = (msg_t *)LightProtC$Packet$getPayload(&LightProtC$packet_buf[sim_node()], sizeof(msg_t ));

      if (__nesc_ntoh_uint16(message->type.nxdata) == 1) {
          sim_log_debug(164U, "radio_send", "packet sent was of type CONNECT\n");


          LightProtC$connect_sent[sim_node()] = FALSE;

          LightProtC$connect_acked[sim_node()] = FALSE;


          LightProtC$Timer1$startOneShot(1000);
        }

      if (__nesc_ntoh_uint16(message->type.nxdata) == 2) {
          sim_log_debug(165U, "radio_send", "packet sent was of type CONNACK\n");

          LightProtC$connack_sent[sim_node()] = FALSE;
        }

      if (__nesc_ntoh_uint16(message->type.nxdata) == 3) {
          sim_log_debug(166U, "radio_send", "packet sent was of type SUBSCRIBE\n");


          LightProtC$subscribe_sent[sim_node()] = FALSE;

          LightProtC$subscribe_acked[sim_node()] = FALSE;


          LightProtC$Timer2$startOneShot(1000);
        }

      if (__nesc_ntoh_uint16(message->type.nxdata) == 4) {
          sim_log_debug(167U, "radio_send", "packet sent was of type SUBACK\n");

          LightProtC$suback_sent[sim_node()] = FALSE;
        }
    }
  else {
#line 315
    sim_log_debug(168U, "radio_send", "there was an error sending the packet\n");
    }
  LightProtC$locked[sim_node()] = FALSE;
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module LightProtC */
  if (!strcmp(varname, "LightProtC$packet_buf"))
  {
    *addr = (uintptr_t)&LightProtC$packet_buf[__nesc_mote];
    *size = sizeof(LightProtC$packet_buf[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$queued_packet"))
  {
    *addr = (uintptr_t)&LightProtC$queued_packet[__nesc_mote];
    *size = sizeof(LightProtC$queued_packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$queue_addr"))
  {
    *addr = (uintptr_t)&LightProtC$queue_addr[__nesc_mote];
    *size = sizeof(LightProtC$queue_addr[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$time_delays"))
  {
    *addr = (uintptr_t)&LightProtC$time_delays[__nesc_mote];
    *size = sizeof(LightProtC$time_delays[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$connect_sent"))
  {
    *addr = (uintptr_t)&LightProtC$connect_sent[__nesc_mote];
    *size = sizeof(LightProtC$connect_sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$connack_sent"))
  {
    *addr = (uintptr_t)&LightProtC$connack_sent[__nesc_mote];
    *size = sizeof(LightProtC$connack_sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$subscribe_sent"))
  {
    *addr = (uintptr_t)&LightProtC$subscribe_sent[__nesc_mote];
    *size = sizeof(LightProtC$subscribe_sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$suback_sent"))
  {
    *addr = (uintptr_t)&LightProtC$suback_sent[__nesc_mote];
    *size = sizeof(LightProtC$suback_sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$publish_sent"))
  {
    *addr = (uintptr_t)&LightProtC$publish_sent[__nesc_mote];
    *size = sizeof(LightProtC$publish_sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$locked"))
  {
    *addr = (uintptr_t)&LightProtC$locked[__nesc_mote];
    *size = sizeof(LightProtC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$communication_channels"))
  {
    *addr = (uintptr_t)&LightProtC$communication_channels[__nesc_mote];
    *size = sizeof(LightProtC$communication_channels[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$connect_acked"))
  {
    *addr = (uintptr_t)&LightProtC$connect_acked[__nesc_mote];
    *size = sizeof(LightProtC$connect_acked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$subscribe_acked"))
  {
    *addr = (uintptr_t)&LightProtC$subscribe_acked[__nesc_mote];
    *size = sizeof(LightProtC$subscribe_acked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$subscribe_topic"))
  {
    *addr = (uintptr_t)&LightProtC$subscribe_topic[__nesc_mote];
    *size = sizeof(LightProtC$subscribe_topic[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LightProtC$simulation"))
  {
    *addr = (uintptr_t)&LightProtC$simulation[__nesc_mote];
    *size = sizeof(LightProtC$simulation[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module LightProtC */
  memset((void *)&LightProtC$packet_buf[__nesc_mote], 0, sizeof LightProtC$packet_buf[__nesc_mote]);
  memset((void *)&LightProtC$queued_packet[__nesc_mote], 0, sizeof LightProtC$queued_packet[__nesc_mote]);
  memset((void *)&LightProtC$queue_addr[__nesc_mote], 0, sizeof LightProtC$queue_addr[__nesc_mote]);
  memcpy((void *)&LightProtC$time_delays[__nesc_mote], (void *)&(unsigned short [9]){ 200, 237, 297, 371, 390, 420, 473, 530, 568 }, sizeof LightProtC$time_delays[__nesc_mote]);
  LightProtC$connect_sent[__nesc_mote] = FALSE;
  LightProtC$connack_sent[__nesc_mote] = FALSE;
  LightProtC$subscribe_sent[__nesc_mote] = FALSE;
  LightProtC$suback_sent[__nesc_mote] = FALSE;
  LightProtC$publish_sent[__nesc_mote] = FALSE;
  memset((void *)&LightProtC$locked[__nesc_mote], 0, sizeof LightProtC$locked[__nesc_mote]);
  memset((void *)&LightProtC$communication_channels[__nesc_mote], 0, sizeof LightProtC$communication_channels[__nesc_mote]);
  LightProtC$connect_acked[__nesc_mote] = FALSE;
  LightProtC$subscribe_acked[__nesc_mote] = FALSE;
  LightProtC$subscribe_topic[__nesc_mote] = 0;
  LightProtC$simulation[__nesc_mote] = 1;
